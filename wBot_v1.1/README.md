...
This guide will walk you through the process of creating a WhatsApp bot using the Meta (formerly Facebook) Cloud API with pure Python, and Flask particular. We'll also integrate webhook events to receive messages in real-time and use OpenAI to generate AI responses. For more information on the structure of the Flask application, you can refer to [this documentation](https://github.com/Arunodaya9027/RJPOLICE_HACK_1224_Atulya_1/tree/master/wBot/app).
...
3. Let's convert that into a [Python function with the request library](https://github.com/Arunodaya9027/RJPOLICE_HACK_1224_Atulya_1/blob/master/wBot/start/whatsapp_quickstart.py).
...
2. On the System Users page, configure the assets for your System User, assigning your WhatsApp app with full control. Don't forget to click the Save Changes button.
   ...
   - Step 1 :
![See step 1 here](https://github.com/Arunodaya9027/RJPOLICE_HACK_1224_Atulya_1/blob/master/wBot/img/meta-business-system-user-token.png)

   - Step 2 :
![See step 2 here](https://github.com/Arunodaya9027/RJPOLICE_HACK_1224_Atulya_1/blob/master/wBot/img/adding-assets-to-system-user.png)
...
- Run your Flask app locally by executing [run.py](https://github.com/Arunodaya9027/RJPOLICE_HACK_1224_Atulya_1/blob/master/wBot/run.py)
...
Now that we have an end to end connection, we can make the bot a little more clever then just shouting at us in upper case. All you have to do is come up with your own `generate_response()` function in [whatsapp_utils.py](https://github.com/Arunodaya9027/RJPOLICE_HACK_1224_Atulya_1/blob/master/wBot/app/utils/whatsapp_utils.py).
...
2. Provide your assistant with data and instructions. [Use this](https://platform.openai.com/docs/assistants/overview) as a sample while developing code
3. Update [openai_service.py](https://github.com/Arunodaya9027/RJPOLICE_HACK_1224_Atulya_1/blob/master/wBot/app/services/openai_service.py) to your use case.
4. Import `generate_reponse` into [whatsapp_utils.py](https://github.com/daveebbelaar/python-whatsapp-bot/blob/main/app/utils/)
5. Update `process_whatsapp_message()` with the new `generate_reponse()` function.
