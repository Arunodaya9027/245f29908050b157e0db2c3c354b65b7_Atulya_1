...
def send_whatsapp_message(RECIPIENT_WAID):
...
# Call the function
# Now RECIPIENT_WAIDS is a list containing multiple WhatsApp IDs
for wa_id in RECIPIENT_WAIDS:
    response = send_whatsapp_message(wa_id)
