        ...
        <SwiperSlide>
          ...
          >
            <ArgonBox position="absolute" bottom={16} ml={6} py={2.5} textAlign="left" width="80%">
              ...
              Apply Now For 5,390 Constable Posts @ Police.rajasthan.gov.in, Apply Now
              </ArgonTypography>
            </ArgonBox>
          </ArgonBox>
        </SwiperSlide>
        <SwiperSlide>
          ...
          >
            <ArgonBox position="absolute" bottom={16} ml={6} py={2.5} textAlign="left" width="80%">
              ...
              <ArgonTypography variant="h5" color="white" mb={0.5}>
              Rajasthan Police Constable 2019 Notification: 
              </ArgonTypography>
              <ArgonTypography variant="body2" color="white">
              कॉन्स्टेबल पदों पर निकली वेकन्सी, पढ़ें ऑफिशल नोटिफिकेशन
              </ArgonTypography>
            </ArgonBox>
          </ArgonBox>
        </SwiperSlide>
        <SwiperSlide>
          ...
          >
            <ArgonBox position="absolute" bottom={16} ml={6} py={2.5} textAlign="left" width="80%">
              ...
              <ArgonTypography variant="body2" color="white">
                Ashok Gehlot Government Decided To Increase 130 Posts In RPS Cadre
              </ArgonTypography>
            </ArgonBox>
          </ArgonBox>
        </SwiperSlide>
